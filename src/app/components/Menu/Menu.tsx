...
const menuItems = [
    ["Not Board", "Won Most Ready to Ship Product to Market! I conducted UX research and developed the Frontend for a fullstack application to help streamline board game nights with tracking, inventory and recommendation systems."],
    ["CYBR", "Can you beat randomness? Designed and developed a game for Dr. Kit Clement and the CATALST statistics curriclum. This game is played by hundereds of students taking STAT 200 at UIUC evey semester"],
    ["Fruit Cutter", "Get fit and have fun! I spearheaded development for a fruit ninja like game built on React.js and tensorflow.js that let 400+ users play a fun and interactive game using their web camera"],
